...
from find_duplicates import generate_duplicates_page  # <-- ВРЕМЕННО: удалить вместе с find_duplicates.py, когда редиректы настроены
...
def main():
    ...
    # <-- ВРЕМЕННО: генерация служебной страницы /dubli со списком дублей.
    # Удалить эту строку вместе с find_duplicates.py и импортом наверху,
    # когда редиректы на canonical настроены и дубли больше не нужно искать. -->
