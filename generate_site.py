...
def format_content(content_string, all_data=None, lang='en'):
    ...
    for block in blocks:
        ...
        if carousel_match and all_data:
            ...
            img_html = f'<p style="margin: 1.5em 0;"><img src="{trimmed_block}" loading="lazy" alt="Embedded content" style="max-width: 100%; height: auto; display: block; margin: 0 auto; border-radius: 4px; border: 1px solid var(--color-border);" /></p>'
