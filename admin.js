    ...
    return `<div class="admin-item" data-id="${item.id}" data-key="${key}" data-status="${item.status || 'published'}">
        <div class="admin-item-content">
            ...
            <div style="display: flex; align-items: center; gap: 10px; margin-top: 5px;">
                <input type="checkbox" class="admin-input-isXDefault" id="xdefault-${item.id}" ${item.isXDefault ? 'checked' : ''} style="width: auto;" disabled>
                <label for="xdefault-${item.id}" style="margin-bottom: 0; cursor: pointer;">Is x-default for this group (SEO)</label>
            </div>
            ...
            case 'save': { 
                ...
                if (key === 'carouselItems') { 
                    ...
                    updatedData = { 
                        ...
                        isXDefault: itemEl.querySelector('.admin-input-isXDefault').checked, // НОВОЕ ПОЛЕ
