    ...
    try { 
        ...
        switch(action) { 
            ...
            case 'add': 
                ...
                let newItemData;
                if (key === 'carouselItems') { 
                    newItemData = { id: newId, lang: defaultLang, order: siteData[key] ? siteData[key].length : 0, groupKey: 'default', imageUrl: 'https://i.pravatar.cc/150?u=' + Date.now(), linkUrl: '#', title: 'New Teammate', role: 'New Role', content: '<p>Bio.</p>', status: 'published' };
                } else { 
