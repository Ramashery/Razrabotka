...
import { getFirestore } from 'firebase/firestore'; // Изменено на firestore/admin
...
// Исправлено: getFirestore импортируется из 'firebase-admin/firestore'
...
async function runPrerender() {
  ...
  try {
    ...
    // Исправлено: Добавлен executablePath для Puppeteer
