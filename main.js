...
function scrollToElementWithOffset(elementId, offset = 120) {
    ...
    const targetPosition = elementTop - viewportCenter + elementHalfHeight;
...
function initStaticEventListeners() { 
    ...
    if (menuToggle && navOverlay) {
        ...
        navOverlay.addEventListener('click', (e) => {
            // Close if click is outside the nav-menu list itself
    ...
    window.addEventListener('scroll', () => {
        ...
        scrollHashUpdateTimer = setTimeout(() => {
            ...
            headings.forEach(heading => {
                ...
                if (rect.top <= viewportMid) bestMatch = heading;
            });
