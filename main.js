...
function renderHero() { 
    ...
    // PERFORMANCE: Если Hero уже есть (статический HTML), не перерисовываем его
...
function initApp() {
    ...
    // 2. PERFORMANCE: Hide loader immediately (if it was visible)
    ...
    // 5. SPA Load: Load data in background after 3 seconds
    setTimeout(() => {
