...
const GEORGIAN_TRANSLIT_MAP = { 'а': 'a', 'б': 'b', 'г': 'g', 'д': 'd', 'е': 'e', 'в': 'v', 'з': 'z', 'т': 't', 'и': 'i', 'к': 'k', 'л': 'l', 'м': 'm', 'н': 'n', 'о': 'o', 'п': 'p', 'ж': 'zh', 'р': 'r', 'с': 's', 'т': 't', 'у': 'u', 'ф': 'p', 'к': 'k', 'г': 'gh', 'к': 'q', 'ш': 'sh', 'ч': 'ch', 'ц': 'ts', 'д': 'dz', 'ц': 'ts', 'ч': 'ch', 'х': 'kh', 'ж': 'j', 'х': 'h' };
...
// FIX 1: ВОССТАНАВЛИВАЕМ ПОЛНУЮ ЛОГИКУ RENDERSECTION ДЛЯ СЛАЙДЕРОВ
...
// FIX 1: ВОССТАНАВЛИВАЕМ ВСПОМОГАТЕЛЬНЫЕ ФУНКЦИИ ДЛЯ СЛАЙДЕРОВ
...
function initStaticEventListeners() { 
    ...
    if (menuToggle && navOverlay) {
        ...
        // FIX 3: ИСПРАВЛЕННАЯ ЛОГИКА ЗАКРЫТИЯ МЕНЮ
        navOverlay.addEventListener('click', (e) => {
            // Закрываем меню только если клик был по самому фону (оверлею), а не по его содержимому (списку ul)
