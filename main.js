...
function renderDetailPage(collection, slug, lang) {
    ...
    // ИЗМЕНЕНИЕ: Добавляем кнопку "Наверх" в HTML детальной страницы
...
async function routeAndRender(isPopState = false) {
    ...
    // ======== ИСПРАВЛЕНИЕ ЗДЕСЬ ========
    // Принудительно проверяем видимость кнопки после каждой смены страницы.
...
function updateScrollButtonVisibility() {
    ...
    // Если мы на странице, где кнопки нет (например, главная), ничего не делаем.
    if (!button) return;
...
function initScrollListener() {
    // Слушатель скролла просто вызывает нашу функцию-проверку
...
async function initApp() { 
    ...
    initScrollListener(); // Запускаем слушатель скролла ОДИН РАЗ при старте приложения
