...
function initStaticEventListeners() { 
    ...
    // ======== ИЗМЕНЕНИЕ ЗДЕСЬ: ДЕЛЕГИРОВАНИЕ СОБЫТИЙ ========
    mainContentEl.addEventListener('click', function(event) {
        // Кнопка отправки квиза
...
function initScrollToTopVisibility() {
    // Эта функция теперь отвечает ТОЛЬКО за показ/скрытие кнопки.
    // Она запускается один раз и работает всегда.
    window.addEventListener('scroll', () => {
        const button = document.getElementById('scroll-to-top-btn');
        if (button) { // Проверяем, есть ли кнопка на странице
...
async function initApp() { 
    ...
    initStaticEventListeners(); // Устанавливаем все "вечные" слушатели кликов
    initScrollToTopVisibility(); // Устанавливаем "вечный" слушатель прокрутки
