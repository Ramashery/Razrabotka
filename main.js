...
function scrollToElementWithOffset(elementId) {
    ...
    // Use absolute offsetTop (not getBoundingClientRect which depends on current scroll)
    let absoluteTop = 0;
    let el = element;
    while (el) { absoluteTop += el.offsetTop; el = el.offsetParent; }
    // Place element at 70% from top of viewport (comfortably visible)
...
function initStaticEventListeners() { 
    ...
    // Close menu on click anywhere outside the nav panel
