...
async function hydrateStaticPage() {
    ...
    const loadFirebaseWhenIdle = () => {
        // Initialize Firebase here, safely inside the idle/timeout callback,
        // so it never blocks the initial render path seen by Googlebot.
        try {
        ...
        loadData()
            .then(data => {
                ...
                // Re-apply dynamic enhancements now that we have live data
