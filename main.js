...
function renderDetailPage(collection, slug, lang) {
    ...
    // --- ВАЖНО: УБРАЛИ ВСЕ SCROLLINTOVIEW И SCROLLTO ---
    // Страница открывается без скроллинга, на текущей позиции
}
...
async function navigateToHome() {
    try {
        ...
        if (newMain) {
            ...
            // --- ВАЖНО: УБРАЛИ SCROLLTO - главная тоже открывается без скроллинга ---
        }
    } catch (error) {
